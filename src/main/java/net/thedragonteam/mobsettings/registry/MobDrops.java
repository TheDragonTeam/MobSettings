...
public class MobDrops {
    ...
    public void playerKilledEntity(LivingDropsEvent event) {
        if (dropOnlyOnPlayerKill)
            if (Objects.equals(event.getSource().getDamageType(), "player")) {
                ...
                if (event.getEntity() instanceof EntityMooshroom)
                    for (int i = 0; i <= (mooshroomCowNumberOfDrops - 1); i++)
                ...
                if (event.getEntity() instanceof EntityIronGolem)
                    for (int i = 0; i <= (ironGolemNumberOfDrops - 1); i++)
                        event.getEntityLiving().dropItem(getItem(ironGolemMobDrops[i]), ironGolemAmountMobDrops[i]);
                if (event.getEntity() instanceof EntitySnowman)
                    for (int i = 0; i <= (snowGolemNumberOfDrops - 1); i++)
                        event.getEntityLiving().dropItem(getItem(snowGolemMobDrops[i]), snowGolemAmountMobDrops[i]);
            } else if (!dropOnlyOnPlayerKill) {
                if (event.getEntity() instanceof EntityCreeper)
                    for (int i = 0; i <= (creeperNumberOfDrops - 1); i++)
                        event.getEntityLiving().dropItem(getItem(creeperMobDrops[i]), creeperAmountMobDrops[i]);
                if (event.getEntity() instanceof EntitySkeleton)
